...
!!! info "Context Block"
    ...
    **Related:** [Metrics & Evaluation](../metrics/metrics_and_evaluation.md) | [Statistical Power](../protocols/statistical_power_and_limits.md) | [Hypothesis Testing](../stats/hypothesis_testing_in_food_spectroscopy.md)
...
- **[Metrics & Evaluation](../metrics/metrics_and_evaluation.md)** — Overview of all metrics
