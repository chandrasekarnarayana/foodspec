...
For practical examples with real models, see [Machine Learning & Deep Learning Models](../methods/chemometrics/models_and_best_practices.md).
...
For practical model choices and troubleshooting, see [ML & DL models](../methods/chemometrics/models_and_best_practices.md) and [Common problems & solutions](../troubleshooting/common_problems_and_solutions.md).
...
See [ANOVA & MANOVA](../methods/statistics/anova_and_manova.md) for theory and code.
...
## See also
- [Visualization with FoodSpec](../user-guide/visualization.md)
...
- [Stats: hypothesis testing](../methods/statistics/hypothesis_testing_in_food_spectroscopy.md)
