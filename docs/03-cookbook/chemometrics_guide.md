...
> For notation see the [Glossary](../09-reference/glossary.md). For practical bands/ratios, see [Feature extraction](../preprocessing/feature_extraction.md#how-to-choose-bands-and-ratios-decision-mini-guide). For metrics, see [Metrics & Evaluation](../metrics/metrics_and_evaluation.md).
