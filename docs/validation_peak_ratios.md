...
> **Status:** Archived  
> This page reflects older peak-ratio validation examples. Refer to the current workflows in [oil_auth_tutorial.md](oil_auth_tutorial.md) and metrics guidance in [metrics/metrics_and_evaluation.md](metrics/metrics_and_evaluation.md).
