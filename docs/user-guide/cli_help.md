...
Cross-reference
- See protocol runner synopsis in [docs/cli.md](cli.md) (section: protocol-runner) and quickstart in [docs/quickstart_protocol.md](../getting-started/quickstart_protocol.md).
