...
**Next steps:**
- See [Quickstart: Python API](quickstart_python.md) for dataset basics
- See [Chemometrics Guide](chemometrics_guide.md) for model selection
- See [Validation Protocols](validation_chemometrics_oils.md) for cross-validation best practices
