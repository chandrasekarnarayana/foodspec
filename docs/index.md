...
- Data/ML practitioners who need reproducible, protocol-based pipelines with validation and reporting.
- Developers extending protocols, vendor loaders, plugins, or deploying FoodSpec services.
...
## For developers
- Architecture overview: [architecture.md](05-advanced-topics/architecture.md)
- Contributing and tests: [contributing.md](06-developer-guide/contributing.md), [testing_and_ci.md](06-developer-guide/testing_and_ci.md)
