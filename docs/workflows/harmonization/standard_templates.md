...
- **See:** [Batch QC / novelty](../quality-monitoring/batch_quality_control.md), [Troubleshooting](../../troubleshooting/common_problems_and_solutions.md).
...
- **See:** [Heating quality monitoring](../quality-monitoring/heating_quality_monitoring.md), [Stats](../../methods/statistics/anova_and_manova.md).

## Mixtures
- **Goal:** Estimate component fractions.
- **Template:** NNLS with pure refs or MCR-ALS → metrics (RMSE/R²) → predicted vs true/residual plots.
- **See:** [Mixture analysis](../quantification/mixture_analysis.md).
