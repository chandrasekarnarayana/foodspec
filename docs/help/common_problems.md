...
- **Fix:** consult [Workflow Design Guide](../workflows/workflow_design_and_reporting.md); pick appropriate metrics/models
...
- [Troubleshooting Guide](troubleshooting.md) – Step-by-step debugging for errors
- [Reporting & Reproducibility](reporting_and_reproducibility.md) – Document results and validation
