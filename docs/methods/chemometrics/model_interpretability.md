...
- **Example (oils):** If oil A vs B separate along PC1 and loadings have strong positive contributions near ~1655 cm⁻¹ (unsaturation), that band is characteristic of oil A. Use [Spectroscopy basics](../../theory/spectroscopy_basics.md) for vibrational assignments.
...
## See also
- Metrics & evaluation: [metrics_and_evaluation](../../reference/metrics_reference.md)
- ML models & best practices: [models_and_best_practices](models_and_best_practices.md)
- Stats: [ANOVA & MANOVA](../statistics/anova_and_manova.md) for group-level effects
