...
- For notation/abbreviations, see the [Glossary](../reference/glossary.md). For a practical bands/ratios guide, see [Feature extraction](../methods/preprocessing/feature_extraction.md#how-to-choose-bands-and-ratios-decision-mini-guide).
...
- Baseline drift and fluorescence → [Baseline correction](../methods/preprocessing/baseline_correction.md).
- Scatter/contact effects → [Normalization & smoothing](../methods/preprocessing/normalization_smoothing.md) and [Scatter & cosmic-ray handling](../methods/preprocessing/scatter_correction_cosmic_ray_removal.md).
- High dimensionality → [PCA](../methods/chemometrics/pca_and_dimensionality_reduction.md).
...
- [PCA and dimensionality reduction](../methods/chemometrics/pca_and_dimensionality_reduction.md)
