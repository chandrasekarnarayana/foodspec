...
- **See also:** [Oil authentication workflow](../workflows/authentication/oil_authentication.md), [Mixture analysis](../workflows/quantification/mixture_analysis.md).
...
- **See also:** [Heating quality monitoring](../workflows/quality-monitoring/heating_quality_monitoring.md).
...
- **See also:** [Hyperspectral mapping](../workflows/spatial/hyperspectral_mapping.md).
