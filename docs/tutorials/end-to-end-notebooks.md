...
## Cross-links
- Getting started: [first-steps_cli.md](../getting-started/first-steps_cli.md)  
- Tutorial: [Oil Authentication](intermediate/01-oil-authentication.md)  
- RQ Engine: [Ratio-Quality Engine](../theory/rq_engine_detailed.md)
