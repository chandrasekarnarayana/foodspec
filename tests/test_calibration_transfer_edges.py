...
def test_pds_handles_large_window_and_small_window():
    ...
    corrected_big, metrics_big = piecewise_direct_standardization(
        X_src, X_tgt, X_tgt, window_size=50
    )
    ...
    corrected_small, metrics_small = piecewise_direct_standardization(
        X_src, X_tgt, X_tgt, window_size=1
    )
