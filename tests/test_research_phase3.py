...
from foodspec.doe.active_design import ActiveDesign, BayesianOptimizer
...
from foodspec.knowledge.graph import CompoundPeakLink, SpectralKnowledgeGraph
from foodspec.modeling.bayesian.bayesian_pls import BayesianNNLS, BayesianPLS, VariationalPLS
...
from foodspec.simulation.spectra_sim import DomainShiftGenerator, InstrumentModel, NoiseModel, SpectraSimulator
