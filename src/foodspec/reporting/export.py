...
class ArchiveExporter:
    ...
    def export(
        ...
        with zipfile.ZipFile(out_zip_path, "w", zipfile.ZIP_DEFLATED, compresslevel=6) as zf:
...
def build_reproducibility_pack(run_dir: str | Path, out_dir: str | Path) -> Path:
...
def verify_archive_integrity(zip_path: str | Path, expected_files: Sequence[str] | None = None) -> bool:
